...
#include "customKLowReWallFunctionFvPatchScalarField.H"
...
customKLowReWallFunctionFvPatchScalarField::customKLowReWallFunctionFvPatchScalarField
(
    const fvPatch& p,
...
customKLowReWallFunctionFvPatchScalarField::customKLowReWallFunctionFvPatchScalarField
(
    const customKLowReWallFunctionFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
customKLowReWallFunctionFvPatchScalarField::customKLowReWallFunctionFvPatchScalarField
(
    const customKLowReWallFunctionFvPatchScalarField& kwfpsf
)
:
...
void customKLowReWallFunctionFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void customKLowReWallFunctionFvPatchScalarField::write(Ostream& os) const
{
...
(
    fvPatchScalarField,
    customKLowReWallFunctionFvPatchScalarField
);
