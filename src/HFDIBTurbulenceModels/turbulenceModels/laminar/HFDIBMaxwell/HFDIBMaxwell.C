...
HFDIBMaxwell<BasicTurbulenceModel>::HFDIBMaxwell
(
...
:
    HFDIBLaminarModel<BasicTurbulenceModel>
    (
        type,
        alpha,
        rho,
...
template<class BasicTurbulenceModel>
bool HFDIBMaxwell<BasicTurbulenceModel>::read()
{
    if (HFDIBLaminarModel<BasicTurbulenceModel>::read())
    {
...
HFDIBMaxwell<BasicTurbulenceModel>::R() const
{
    return sigma_;
}
...
template<class BasicTurbulenceModel>
tmp<Foam::volSymmTensorField>
HFDIBMaxwell<BasicTurbulenceModel>::devRhoReff() const
{
...
template<class BasicTurbulenceModel>
tmp<Foam::volSymmTensorField>
HFDIBMaxwell<BasicTurbulenceModel>::devRhoReff(const volVectorField& U) const
{
...
HFDIBMaxwell<BasicTurbulenceModel>::divDevRhoReff
(
    volVectorField& U
) const
{
...
template<class BasicTurbulenceModel>
void HFDIBMaxwell<BasicTurbulenceModel>::correct()
{
    // Local references
    ...
    HFDIBLaminarModel<BasicTurbulenceModel>::correct();
